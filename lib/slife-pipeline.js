...
var getPipeline = function() {
    ...
    var execute = function(normal, fromStep, toStep, resolve, reject) {
        ...
        logger.info("Executing pipeline","[","#bold",normal.orig,"]","steps:",steps);
    ...
    /**
     * Filter steps 'from' and 'to' the step in params
     *
     * @param pipeline
     * @param fromStep
     * @param toStep
    ...
    var filterSteps = function(pipeline, fromStep, toStep){
        ...
        logger.trace("#green","slife-pipeline:filterSteps","steps before:",steps);
        ...
        logger.trace("#green","slife-pipeline:filterSteps","steps after:",steps);
        return steps;
    };

    /**
     * Run all precondition of all the steps of the pipeline
     *
     * @param pipeline
     * @param fromStep
     * @param toStep
