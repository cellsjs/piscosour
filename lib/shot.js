...
Shot.setAddons = function(addons){
    for (var name in addons){
        Shot.prototype[name] = addons[name];
    }
};
...
Shot.prototype.doPlugins = function(stage){
    ...
    for (var name in this.plugins){
        ...
        var operation = plugin.runner[stage];
...
Shot.prototype.execute = function(cmd,args,resolve, reject){
    ...
    logger.info("#cyan","executing async",cmd,args);
...
Shot.prototype.report = function(result) {
    ...
    console.log(this.runner.name+"--->",global[this.runner.name]["xxreport"]);
};
